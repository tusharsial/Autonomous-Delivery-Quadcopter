...
class Edrone():
   ...
   # ----------------------------------------------------------------------------------------------------------------------
    ...
    def pid(self):
        ...
        self.sum_error[0] = max(-10,min(10,self.sum_error[0]+self.error[0]*self.Ki[0]))
        self.sum_error[1] = max(-10,min(10,self.sum_error[1]+self.error[1]*self.Ki[1]))
        self.sum_error[2] = max(-10,min(10,self.sum_error[2]+self.error[2]*self.Ki[2]))
